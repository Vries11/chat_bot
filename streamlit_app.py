...
#         options=["简介","详细"],
#)
##st.chat_message("assistant").write("我是你的学习的助手") 输入框
##user_input = st.chat_input("你的问题/你的需求") 赋值输入框
#st.session_state["messages"] =[
#    {"role":"assistant","content":"你好,我是你的学习助手"},  
#]
#st.session_state["messages"].append(
#    {"role":"human","content":"请问你要帮我学习吗"}
#    )
#for message in st.session_state["messages"]:
#    st.chat_message(message["role"]).write(message["content"]) #role是返回assistant图标
#
